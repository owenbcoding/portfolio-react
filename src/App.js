    ...
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <a href="#" className="flex items-center">
          ...
          <li className="ml-4 text-lg">About</li>
        </a>
      </Typography>
      <Typography
        as="li"
      ...
      >
        <a href="#" className="flex items-center">
          ...
          <li className="ml-4 text-xl">Projects</li>
        </a>
      </Typography>
      <Typography
        as="li"
      ...
      >
        <a href="#" className="flex items-center">
          ...
          <li className="ml-4 text-xl">Blogs</li>
        </a>
      </Typography>
      <Typography
        as="li"
      ...
      >
        <a href="#" className="flex items-center">
          ...
          <li className="ml-4 text-xl">Contact</li>
        </a>
      </Typography>
    </ul>
  );
      ...
      <Navbar className="mx-auto max-w-full px-4 py-2 lg:px-8 lg:py-4">
        <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
          <Typography
            as="a"
            href="#"
            className="mr-4 cursor-pointer block antialiased font-sans text-blue-gray-900 text-lg font-bold"
          >
            Owencodes
          </Typography>
